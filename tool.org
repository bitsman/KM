...
:COPYING:  t
:END:
This manual is for bitman study Sample (version {{{version}}}, {{{updated}}}), which
is an example in the documentation. Copyright @@texinfo:@copyright{}@@ 2013 bitman, Inc. 
#+BEGIN_QUOTE
...
- options: 带一定的[[http://orgmode.org/org.html#Export-settings][参数]] 可以配置不同的导出形式, 见表\ref{tbl-option-para},
  ...
  | 竖线 :     | turn on/off tables                                                |
  | ^:         | turn on/off TeX-like syntax for sub- and superscripts.  If        |
  |            | you write "^:{}", a_{b} will be interpreted, but                  |
  |            | the simple a_b will be left as it is.                             |
  | 横线:      | turn on/off conversion of special strings.                        |
